...
<table width="550" border="0" align="center" cellpadding="10" cellspacing="0">
    <tr> 
        <td>Confirmation de la commande - Etape 2/3</td>
    </tr>
</table>
...
<!--    <table width="550" border="0" align="center" cellpadding="10" cellspacing="0">
        <tr> 
            <td align="center"><strong>:: NOTE IMPORTANTE :: </strong></td>
        </tr>
        <tr> 
            <td><p>Avant ce cliquer sur le bouton &quot;Confirmer la commande&quot; button open a 
...
?>
    <table width="550" border="0" align="center" cellpadding="5" cellspacing="1" class="infoTable">
        <tr class="infoTableHeader"> 
            <td colspan="3">Produit commandé</td>
        </tr>
        <tr class="label"> 
            <td>Produit</td>
            <td>Prix unitaire</td>
...
?>
        ...
        <tr class="content"> 
            <td colspan="2" align="right">Livraison</td>
    ...
    <table width="550" border="0" align="center" cellpadding="5" cellspacing="1" class="infoTable">
        <tr class="infoTableHeader"> 
            <td colspan="2">Livraison Information</td>
        </tr>
        <tr> 
    ...
    <table width="550" border="0" align="center" cellpadding="5" cellspacing="1" class="infoTable">
        <tr class="infoTableHeader"> 
            <td colspan="2">Informations de paiement</td>
        </tr>
        <tr> 
            <td width="150" class="label">Prénom</td>
