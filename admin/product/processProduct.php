...
function addProduct()
{
	...
	$sql   = "INSERT INTO plantons_product (cat_id, pd_name, pd_description, pd_price, pd_qty, pd_image, pd_thumbnail, pd_date)
...
function deleteProduct()
{
	...
	// plantons_order_item and plantons_cart
	$sql = "DELETE FROM plantons_order_item
	        WHERE pd_id = $productId";
	dbQuery($sql);
	...
	$sql = "DELETE FROM plantons_product 
	        WHERE pd_id = $productId";
	dbQuery($sql);
